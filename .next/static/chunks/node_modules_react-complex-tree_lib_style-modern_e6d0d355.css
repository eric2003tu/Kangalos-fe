/* [project]/node_modules/react-complex-tree/lib/style-modern.css [app-client] (css) */
:root {
  ...
  --rct-color-renaming-input-submitbutton-text-hover: #fff;
  --rct-color-renaming-input-submitbutton-text-active: #fff;
}
...
.rct-tree-item-arrow, .rct-tree-item-arrow svg {
  width: 10px;
}
...
.rct-rtl .rct-tree-item-title-container-selected .rct-tree-item-button:before {
  left: unset;
  right: calc(-.5 * var(--rct-bar-width));
}
...
/*# sourceMappingURL=node_modules_react-complex-tree_lib_style-modern_e6d0d355.css.map*/