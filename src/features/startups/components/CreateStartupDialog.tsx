...
import { useCreateStartup } from "../hooks/useStartupHooks";
import {
  CreateStartupForm,
  createStartupSchema,
...
export default function CreateStartupDialog({
  isOpen,
  onClose,
}: CreateStartupDialogProps) {
  const t = useTranslations("startups");
  const [isSubmitting, setIsSubmitting] = useState(false);
  const { mutateAsync: createStartup } = useCreateStartup();

  const form = useForm<CreateStartupForm>({
