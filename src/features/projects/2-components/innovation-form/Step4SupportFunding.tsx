import { StepProps, SUPPORT_TYPES, SUPPORT_PROVIDERS, NON_MONETARY_SUPPORT_TYPES, EXPECTED_FUNDERS, FormData } from "./types";
  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-foreground mb-2">Support & Funding History</h2>
        <p className="text-muted-foreground">Past funding received and future funding needs</p>
      </div>
